...
public abstract class Config {
    ...
    public static final DoubleConfig TUNNEL_WIDTH;
    public static final DoubleConfig TUNNEL_HEIGHT;
    public static final DoubleConfig TUNNEL_LONG;
    public static final DoubleConfig EXCAVATE_MAX_BLOCKS;
    public static final DoubleConfig EXCAVATE_RANGE;
    public static final BooleanConfig LIGHT_OVERLAY_ENABLE;
    public static final DoubleConfig LIGHT_OVERLAY_RANGE;
    public static final DoubleConfig PICKUP_DISTANCE;
    static {
